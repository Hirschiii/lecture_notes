...
\setuphead[chapter]            [header=empty,number=no,sectionresetset=1]
\setuphead[section]            []
\setuphead[subsection]         []
\setuphead[subsubsection]      [style=\bf,number=no]
\setuphead[subsubsubsection]   [style=\sc,number=no]
\setuphead[subsubsubsubsection][style=\it,number=no]
