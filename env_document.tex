...
%    % align=left, % Align margin notes to the left
%    stack=no,
%    style=\tfx\setupinterlinespace, % Smaller font and italics for margin notes
%    % style={\tfx\setupinterlinespace, \setupalign[block]},
%    before={\blank[medium]}, % Space before margin note
%    after={\blank[small]}]

\setupmargindata[inmargin][location=right,style=\tfx\setupinterlinespace,align=left]
...
\setuplayout
  [backspace=2cm, % Space on the left margin
   ...
   rightmargin=4cm, % Space for margin notes
