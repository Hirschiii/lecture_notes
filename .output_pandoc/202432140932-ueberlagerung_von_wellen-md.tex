...
Im ersten Beispiel\cite{fig:waves_no_offset} wird die Amplitude {\em
verdoppelt}, im zweiten Beispiel\cite{fig:waves_offset} gleichen sich
die beiden Wellen zu {\em keiner} Welle aus.
